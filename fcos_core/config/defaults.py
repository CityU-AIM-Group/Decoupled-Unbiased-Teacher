...
_C.SOLVER.SFDA_PSEUDO_TH = 0.7
_C.SOLVER.UNCERTAINTY_EPSILON = 0.0 # a epsilon value added to the uncertainty
# For EMA
_C.SOLVER.SFDA_TEACHER_UPDATE_ITER = 1
_C.SOLVER.SFDA_EMA_KEEP_RATE = 0.999
# For loss
_C.SOLVER.SFDA_REG_ON = False
_C.SOLVER.SFDA_CTR_ON = True
# For the optimizer
_C.SOLVER.ADAM = False
_C.SOLVER.UGOB = 'v2' # None for CSP_OFF
#####################################
_C.SOLVER.DIA_ON = True
_C.SOLVER.DIA_MIXUP_MIN = 0.7
_C.SOLVER.FEATURE_INTERVAL = True
# _C.SOLVER.CSP_ON = True
_C.SOLVER.TEACHER_UPDATE_METHOD = 'decouple'
_C.SOLVER.COS_TH = 0.7

_C.SOLVER.RANDOM_BANK_ON = False
_C.SOLVER.DIA_SEM_ONLY = False

_C.SOLVER.IUGS = False
_C.SOLVER.IUGS_TH = 0.8
